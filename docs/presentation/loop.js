...
(function () {
  ...
  var NODES = [
    { name: 'engineer', cx: 340, cy: 300, shape: 'circle', r: 30, label: 'engineer · head chef', stageIn: 1 },
    { name: 'agent', cx: 560, cy: 300, shape: 'rect', w: 150, h: 56, label: 'agent · line cook', stageIn: 1, cls: 'amber' },
    { name: 'review', cx: 1000, cy: 300, shape: 'rect', w: 150, h: 56, label: 'review · plating check', stageIn: 1 },
    { name: 'verify', cx: 800, cy: 300, shape: 'rect', w: 150, h: 56, label: 'verify · taste test', stageIn: 2, cls: 'verify' },
    { name: 'board', cx: 140, cy: 80, shape: 'rect', w: 150, h: 56, label: 'board · new ticket', stageIn: 3, cls: 'card' },
    { name: 'grill', cx: 330, cy: 80, shape: 'rect', w: 150, h: 56, label: 'grill · waiter', stageIn: 3 },
    { name: 'story', cx: 520, cy: 80, shape: 'rect', w: 150, h: 56, label: 'story · ticket + recipe', stageIn: 3 },
    { name: 'g1', cx: 700, cy: 80, shape: 'diamond', w: 140, h: 92, label: 'G1 — PASS 1 · PO + Lead', stageIn: 4, cls: 'gate' },
    { name: 'quality', cx: 520, cy: 150, shape: 'chip', w: 110, h: 30, label: 'quality check', stageIn: 4, cls: 'chip' },
    { name: 'plan', cx: 860, cy: 80, shape: 'rect', w: 150, h: 56, label: 'plan · prep list', stageIn: 5 },
    { name: 'queue', cx: 560, cy: 215, shape: 'strip', w: 270, h: 34, label: 'task queue · ticket rail', stageIn: 5 },
    { name: 'agent2', cx: 560, cy: 390, shape: 'rect', w: 150, h: 56, label: 'agent · line cook — lane 2', stageIn: 5, cls: 'amber' },
    { name: 'verify2', cx: 800, cy: 390, shape: 'rect', w: 150, h: 56, label: 'verify · taste test — lane 2', stageIn: 5, cls: 'verify' },
    { name: 'agent3', cx: 560, cy: 460, shape: 'rect', w: 150, h: 56, label: 'agent · line cook — lane 3', stageIn: 5, cls: 'amber' },
    { name: 'verify3', cx: 800, cy: 460, shape: 'rect', w: 150, h: 56, label: 'verify · taste test — lane 3', stageIn: 5, cls: 'verify' },
    ...
    { name: 'g2', cx: 1140, cy: 300, shape: 'diamond', w: 140, h: 92, label: 'G2 — PASS 2 · FSDev + QA', stageIn: 6, cls: 'gate' },
    { name: 'mention', cx: 1000, cy: 210, shape: 'chip', w: 110, h: 30, label: '@mention', stageIn: 6, cls: 'chip' },
    { name: 'release', cx: 1140, cy: 440, shape: 'rect', w: 150, h: 56, label: 'release · send-out pack', stageIn: 7 },
    { name: 'g3', cx: 1000, cy: 530, shape: 'diamond', w: 140, h: 92, label: 'G3 — PASS 3 · signatures', stageIn: 7, cls: 'gate' },
    { name: 'deploy', cx: 800, cy: 530, shape: 'rect', w: 150, h: 56, label: 'deploy · to the table', stageIn: 7 },
    { name: 'monitor', cx: 560, cy: 530, shape: 'rect', w: 150, h: 56, label: 'monitor · the critic', stageIn: 8 },
    { name: 'card', cx: 330, cy: 530, shape: 'small', w: 120, h: 44, label: 'card · complaint', stageIn: 8, cls: 'card' }
  ];
  ...
  var EDGES = [
    ...
    { name: 'review-engineer', a: 'review', b: 'engineer', label: 'read the diff · looks at the plate', stageIn: 1, stageOut: 6, thin: true, curve: [860, 210] },
    ...
    { name: 'engineer-board', a: 'engineer', b: 'board', label: 'files a card · places an order', stageIn: 3 },
